...
const data = {
  bgImage: "/images/insomnia-clinic.jpg", // Replace with your actual image path
  sidebarLinks: [
    { title: "CBT for Insomnia", link: "/cbt-insomnia" },
    { title: "Mindfulness Therapy", link: "/mindfulness" },
    { title: "Sleep Apnea Program", link: "/sleep-apnea" },
  ],
};
