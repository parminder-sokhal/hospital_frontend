...
const data = {
  bgImage: "/images/tension-headache-bg.jpg", // Replace with your image path
  sidebarLinks: [
    { title: "Migraine Clinic", link: "/migraine-clinic" },
    { title: "Cluster Headaches", link: "/cluster-headaches" },
    { title: "Sinus Headaches", link: "/sinus-headaches" },
  ],
};
