...
const data = {
  bgImage: '/images/bipolar.jpg', // Replace with actual image path
  sidebarLinks: [
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="px-10 lg:px-40 py-10">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Bipolar Disorder: A Complete Guide</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <p><strong>What is Bipolar Disorder?</strong><br />
              Bipolar Disorder is a chronic mental health condition characterized by extreme mood swings that include emotional highs (mania or hypomania) and lows (depression). These shifts in mood, energy, and activity levels can severely impact a person's ability to function in daily life.
            </p>

            <p>
              While it is a lifelong condition, with the right treatment and support, people with bipolar disorder can live stable, productive lives.
            </p>

            <h2 className="text-xl font-semibold">Types of Bipolar Disorder</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Bipolar I Disorder:</strong> At least one manic episode lasting 7+ days or requiring hospitalization. Often includes depressive episodes and psychotic symptoms.</li>
              <li><strong>Bipolar II Disorder:</strong> At least one major depressive and one hypomanic episode. No full manic episodes.</li>
              <li><strong>Cyclothymic Disorder:</strong> Milder but chronic mood fluctuations lasting 2+ years (1 year in children).</li>
              <li><strong>Other Specified/Unspecified:</strong> Bipolar-like symptoms that don't meet standard diagnostic criteria.</li>
            </ul>

            <h2 className="text-xl font-semibold">Symptoms of Bipolar Disorder</h2>
            ...
            <p>Less severe than mania, often unrecognized. May appear as increased energy or productivity without major impairment.</p>
            ...
            <p className="italic">Note: Mixed episodes involve symptoms of both mania and depression simultaneously.</p>

            <h2 className="text-xl font-semibold">Causes and Risk Factors</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Genetics:</strong> Strong family history link</li>
              <li><strong>Brain chemistry:</strong> Neurotransmitter imbalances (dopamine, serotonin)</li>
              <li><strong>Stress and trauma:</strong> Can trigger episodes</li>
              <li><strong>Substance use:</strong> May worsen symptoms</li>
              <li><strong>Sleep disruption:</strong> Can destabilize mood</li>
            </ul>

            <h2 className="text-xl font-semibold">Diagnosis</h2>
            <p>
              Diagnosed by a mental health professional using clinical interviews, history, DSM-5/ICD-11 criteria, and tools like the Mood Disorder Questionnaire (MDQ). Often misdiagnosed as depression, especially in Bipolar II.
            </p>

            <h2 className="text-xl font-semibold">Treatment of Bipolar Disorder</h2>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Transcranial Magnetic Stimulation (TMS) for bipolar depression</li>
            </ul>

            <h2 className="text-xl font-semibold">Living With Bipolar Disorder</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p className="text-red-600 font-semibold">
              Emergency Help: If someone is in immediate danger, contact emergency services or a suicide prevention hotline right away.
            </p>

            <h2 className="text-xl font-semibold">Prognosis and Outlook</h2>
            <p>
              Bipolar disorder is lifelong, but with early diagnosis, consistent treatment, and lifestyle support, most people lead fulfilling lives with well-managed symptoms.
            </p>

            <h2 className="text-xl font-semibold">Conclusion</h2>
            <p>
              Bipolar disorder is a medical condition—not a character flaw. With understanding, compassion, and comprehensive care, those affected can thrive and succeed.
            </p>
