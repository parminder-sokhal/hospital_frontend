...
const data = {
  bgImage: "/images/seizure-bg.jpg", // Replace with your image path
  sidebarLinks: [
    { title: "Epilepsy Clinic", link: "/epilepsy-clinic" },
    { title: "Seizure Treatment Options", link: "/seizure-treatment" },
    { title: "Neurology Services", link: "/neurology-services" },
  ],
};
