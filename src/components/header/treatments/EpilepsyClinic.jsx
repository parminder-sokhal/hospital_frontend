...
const data = {
  bgImage: "/images/epilepsy-bg.jpg", // Replace with your image path
  sidebarLinks: [
    { title: "Seizure Types", link: "/seizure-types" },
    { title: "Epilepsy Surgery", link: "/epilepsy-surgery" },
    { title: "Diet and Lifestyle", link: "/diet-lifestyle" },
  ],
};
