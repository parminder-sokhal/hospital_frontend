...
const data = {
  bgImage: "/images/dhat-syndrome.jpg", // Replace with your actual image path
  sidebarLinks: [
    { title: "Sexual Wellness Services", link: "/sexual-wellness" },
    { title: "Premature Ejaculation Program", link: "/premature-ejaculation" },
    { title: "Erectile Dysfunction Program", link: "/erectile-dysfunction" },
  ],
};
