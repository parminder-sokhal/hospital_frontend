...
const Header = () => {
  return (
    <header className="bg-[#102A83] text-white py-2 px-4 fixed top-0 left-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-around space-x-4">
        <div className="flex items-center space-x-6 text-sm sm:hidden md:hidden">
        ...
        <div className="container mx-auto items-center justify-around space-x-4 hidden sm:flex md:flex">
